...
public class CurrenciesTest {
    ...
    /**
     * Test of getCurrencyString method, of class Currencies.
     */
    @Test
    public void testGetCurrencyString_Locale_double() {
        double currency = 123.456;
        String currencyString = Currencies.getCurrencyString(Locales.spanish(), currency);
